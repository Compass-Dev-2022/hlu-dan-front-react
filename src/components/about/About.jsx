...
const About = () => {
  return (
    <div className="mt-40 md:mt-[70%] xl:mt-20 mb-40 " id="about">
      <Intro />
      <IntroCards />
      <AboutUs />
      <AboutCategory />
...
const Intro = () => {
  return (
    <div className="py-20 px-4 xl:py-20 xl:px-20  relative">
...
const AboutUs = () => {
  return (
    <div className="w-[90%]  h-full xl:px-20  mt-[10%] mx-auto ">
      <p className="text-[20px] text-primary mb-3">ABOUT US </p>
...
const AboutCategory = ({}) => {
  ...
  return (
    <div className="w-[90%] mx-auto xl:px-20 xl:flex justify-between items-center mt-20">
      <div>
        <div className="bg-category-about-mobile w-full h-[20rem] xl:w-[736px] xl:h-[531px] xl:bg-category-about bg-no-repeat"></div>
...
const AboutCategoryCard = ({ icon, id, text, desc }) => {
  return (
    <div className="xl:flex justify-between pb-10 border-b border-clr-0-0-78 mt-10">
      <img src={icon} alt="" />
...
const Category = () => {
  return (
    <div className="xl:flex justify-between items-center px-4 xl:px-20 my-40">
      <div className="h-full xl:w-[640px]  xl:h-[420px] flex flex-col items-start justify-around">
      ...
      <div className="mt-20 xl:mt-0 xl:w-[420px] h-[420px] bg-play-video bg-cover bg-no-repeat flex justify-center items-center">
...
const SelflessTeamMember = () => {
  ...
  return (
    <div className="flex flex-col gap-y-20 xl:flex xl:flex-row justify-around mt-20">
...
const SelflessTeamCard = ({ name }) => {
  return (
    <div className="xl:w-[230px] h-auto flex flex-col justify-center items-center">
